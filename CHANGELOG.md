...
### Changed
- 🦊 **Firefox Fork Compatibility**: Lowered Firefox `strict_min_version` from `142.0` to `115.0` in `platform/firefox/manifest.json` to support Firefox ESR 115/128 and Firefox engine forks (Waterfox, Zen Browser, Floorp, LibreWolf).
...
- 🤖 **CodeRabbit AI Code Review**: Added `.coderabbit.yaml` and `.github/pull_request_template.md` for automated AI code reviews on Pull Requests.
