...
import { api, promisify } from './webextension-polyfill.js';

/**
 * Finds the browser's Bookmarks Bar / Toolbar root node ID
 */
export async function findBookmarksBarId() {
 ...
 */
export async function cleanExistingFMHYFolders() {
 ...
 */
export async function syncFMHYBookmarks(parsedTree) {
  try {
